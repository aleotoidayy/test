...
// =========    phan co dinh  ========= //
let ua=$request.headers["user-agent"],obj=JSON.parse($response.body),subscriptionInfo={is_sandbox:!1,ownership_type:"PURCHASED",billing_issues_detected_at:null,period_type:"PERMANENT",expires_date:"2099-01-01T01:01:15Z",grace_period_expires_date:null,unsubscribe_detected_at:null,original_purchase_date:"2022-08-17T01:05:06Z",purchase_date:"2022-08-17T01:05:06Z",store:"app_store"};obj.subscriber.subscriptions["some.product.id"]=subscriptionInfo,obj.subscriber.entitlements["some.entitlement.key"]={purchase_date:"2022-08-17T01:05:06Z",expires_date:"2099-01-01T01:01:15Z",product_identifier:"some.product.id"},console.log("dang ki da sua doi!"),$done({body:JSON.stringify(obj)});
